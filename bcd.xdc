...
connect_debug_port u_ila_0/probe2 [get_nets [list dir_IBUF]]
create_debug_port u_ila_0 probe
...
##Switches
set_property -dict {PACKAGE_PIN G15    IOSTANDARD LVCMOS33} [ get_ports { ------ }]; #Sch=sw[0]
...
##RGB LED 6
#set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { dispense_item[0] }]; #IO_L18P_T2_34 Sch=led6_r
#set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { dispense_item[1] }]; #IO_L6N_T0_VREF_35 Sch=led6_g
#set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { dispense_item[2] }]; #IO_L8P_T1_AD10P_35 Sch=led6_b
